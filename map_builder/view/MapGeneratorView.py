...
class MapGeneratorView(View):
    ...
    def _init_map_frame(self):
        ...
        self._width_map = tk.StringVar()
        self._height_map = tk.StringVar()
    ...
    def _init_tile_frame(self):
        ...
        self._width_tile = tk.StringVar()
        self._height_tile = tk.StringVar()
    ...
    def _create_spinbox(self, parent, pos, var):
        spinbox = Spinbox(parent, from_=self._NUMBER_FROM, to=self._NUMBER_TO,
    ...
    def _create_map(self):
        self._dict_values["width_map"] = int(self._width_map.get())
        self._dict_values["height_map"] = int(self._height_map.get())
        self._dict_values["width_tile"] = int(self._width_tile.get())
        self._dict_values["height_tile"] = int(self._height_tile.get())
        self.change()
